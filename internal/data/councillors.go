...
var CouncilByTerm = map[int]CouncilTerm{
	2022: {
		Mayor: models.Councillor{
			...
			StatusURL:    "https://www.cbc.ca/news/canada/thunder-bay/boshcoff-career-1.7635151",
		...
		AtLarge: []models.Councillor{
			...
			},
			{
				...
				Term:         "3rd term",
				Status:       "Stepping down",
				StatusURL:    "https://www.tbnewswatch.com/local-journalism-initiative-lji/after-12-years-shelby-chng-to-step-away-from-city-council-12112059",
		...
		Ward: []models.Councillor{
			...
			},
			{
				...
				Term:         "2nd term",
				Status:       "Stepping down",
				StatusURL:    "https://yourthunderbay.ca/westforts-councillor-will-not-be-seeking-re-election/",
